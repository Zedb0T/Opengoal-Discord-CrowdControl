...
public class Commands extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
        if (!event.getMember().getId().equalsIgnoreCase("878434802049642537")) {
            ...
            //todo add a way to terminate this
            ...
            if (args[0].equalsIgnoreCase("!rjto") || args[0].equalsIgnoreCase("!setrolljump")) {
            ...
            //todo check to see if these are correct values, maybe break them down into LISP
            ...
            //todo review these commands I'm not sure the values are right
            ...
            if (args[0].equalsIgnoreCase(("!nopunching"))) {
                //Make sure eco-full-timeout isn't 0 can maybe do an if statement here
                //todo
            ...
            //todo find a way to listen for commands during the sleep, or just make this a toggle lmao
            ...
            //todo add a version of this to change mood to anything
            ...
            if (args[0].equalsIgnoreCase(("!heal"))) {
                main.runCommand("(set! (-> (the-as fact-info-target (-> *target* fact))health) 4.0)");
            }
            if (args[0].equalsIgnoreCase(("!1hp"))) {
                main.runCommand("(set! (-> (the-as fact-info-target (-> *target* fact))health) 1.0)");
            }
            if (args[0].equalsIgnoreCase(("!setecotime"))) {
                main.runCommand("(set! (-> *FACT-bank* eco-full-timeout) (seconds " + args[1] + "))");
            }
            if (args[0].equalsIgnoreCase(("!flutflutspeed"))) {
            ...
            if (args[0].equalsIgnoreCase("!repl") &&
                ...
                for (int i = 1; i < args.length; i++) {
                    //Add all argments in args Array to a string to pass to REPL
...
// fastflutflut (set! (-> *flut-walk-mods* target-speed)(meters 50.0))
    ...
    //todo finish this one. (cant reset !repl obviously)
